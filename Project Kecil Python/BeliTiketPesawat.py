...
while loop:
    ...
    if ((tujuan) == 1):
        ...
        print("-"*15)
        print("\n101.   Citilink\tJakarta \tRp. 900,000")
        print("\n102.   Garuda\tJakarta   \tRp. 1.500,000")
        print("\n103.   Nam Air\tJakarta \tRp. 800,000")
        print("-"*20)
        ...
        print("\nKode    Nama\tKota\tHarga")
        print("-"*10)
        print("\n201.   Garuda\tBali\tRp. 1.500,000")
        print("\n202.   NAM air\tBali\tRp. 1.000,000")
        print("\n203.   Batik\tBali\tRp. 1.100,000")
        print("-"*20)
        no_pesawat = int(input("Masukkan kode penerbangan   :   "))
        ...
        print("\nKode    Nama\tKota\tHarga")
        print("-"*10)
        print("\n301.   Batik\tPalembang    \tRp. 800,000")
        print("\n302.   NAM air\tPalembang    \tRp. 700,000")
        print("\n303.   Citilink\tPalembang  \tRp. 900.000")
        print("-"*20)
        no_pesawat = int(input("Masukkan kode penerbangan   :   "))
